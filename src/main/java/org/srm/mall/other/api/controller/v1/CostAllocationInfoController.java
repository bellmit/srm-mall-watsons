...
public class CostAllocationInfoController extends BaseController {
    ...
    public ResponseEntity<List<ProjectCost>> selectAllocationProjectLov(@PathVariable("organizationId") Long organizationId, @RequestParam("itemCategoryId") Long itemCategoryId, @RequestParam("itemId") Long itemId, @RequestParam("size") Integer size, @RequestParam("page") Integer page) {
